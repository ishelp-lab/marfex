...
const sinkFinishes = [
  ...
  },
  {
    ...
    image: "/images/showcase/area-molhada-tradicional.jpeg",
    description:
      "Modelo tradicional, funcional e eficiente para o uso diário em bancadas e pias.",
  },
]
...
function ShowcaseImage({
  ...
  return (
    <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-white/5 shadow-2xl">
      <div className="relative mx-auto aspect-[895/1200] w-full max-w-[895px]">
        <Image
          key={image}
          src={image}
          alt={name}
...
export function MaterialsShowcaseSection() {
  ...
  const firstFinish = useMemo(() => sinkFinishes[0], [])
  ...
  const activeFinish = sinkFinishes[activeFinishIndex] ?? firstFinish
        ...
        <div className="space-y-14 lg:hidden">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <div className="space-y-2">
                {materials.map((material, index) => {
                  const isActive = activeMaterialIndex === index
          ...
          <div className="space-y-6">
            <ShowcaseImage
              image={activeFinish.image}
              name={activeFinish.name}
              description={activeFinish.description}
            />
            ...
            <div>
              ...
              <div className="space-y-2">
                {sinkFinishes.map((finish, index) => {
                  const isActive = activeFinishIndex === index
